...
var adminContribution = {
    view: function view(ctrl, args) {
        ...
        return m$1('.w-row.admin-contribution', [m$1('.fontweight-semibold.lineheight-tighter.u-marginbottom-10.fontsize-small', '$' + contribution.value), m$1('.fontsize-smallest.fontcolor-secondary', h.momentify(contribution.created_at, 'DD/MM/YYYY HH:mm[h]')), m$1('.fontsize-smallest', ['Gateway ID: ', m$1('a.alt-link[target="_blank"][href="https://dashboard.pagar.me/#/transactions/' + contribution.gateway_id + '"]', contribution.gateway_id)])]);
    }
};
        ...
        displayPaymentMethod = function displayPaymentMethod() {
            switch (payment.payment_method.toLowerCase()) {
                ...
                case 'cartaodecredito':
                    var cardData = card();
                    if (cardData) {
                        return m$1('#creditcard-detail.fontsize-smallest.fontcolor-secondary.lineheight-tight', [cardData.first_digits + '******' + cardData.last_digits, m$1('en'), cardData.brand + ' ' + payment.installments + 'x']);
                    }
                    return '';
            }
        };
...
var adminRadioAction = {
    ...
    view: function view(ctrl, args) {
        ...
        return m$1('.w-col.w-col-2', [m$1('button.btn.btn-small.btn-terciary', {
            ...
            }), m$1('label.w-form-label[for="r-' + index + '"]', '$' + radio.minimum_value)]);
...
var adminTransaction = {
    view: function view(ctrl, args) {
        ...
        return m$1('.w-col.w-col-4', [m$1('.fontweight-semibold.fontsize-smaller.lineheight-tighter.u-marginbottom-20', 'Contribution details'), m$1('.fontsize-smallest.lineheight-looser', ['Value: $' + h.formatNumber(contribution.value, 2, 3), m$1('en'), 'Rate: $' + h.formatNumber(contribution.gateway_fee, 2, 3), m$1('en'), 'Waiting confirmation: ' + (contribution.waiting_payment ? 'Yes' : 'No'), m$1('en'), 'Anonymous: ' + (contribution.anonymous ? 'Yes' : 'No'), m$1('en'), 'Payment ID: ' + contribution.gateway_id, m$1('en'), 'Support: ' + contribution.contribution_id, m$1('en'), 'Key: \n', m$1('en'), contribution.key, m$1('en'), 'Medium: ' + contribution.gateway, m$1('en'), 'Operator: ' + (contribution.gateway_data && contribution.gateway_data.acquirer_name), m$1('en'), contribution.is_second_slip ? [m$1('a.link-hidden[href="#"]', 'Bank slip'), ' ', m$1('span.badge', '2nd route')] : ''])]);
    }
};
...
var adminReward = {
    view: function view(ctrl, args) {
        ...
        return m$1('.w-col.w-col-4', [m$1('.fontweight-semibold.fontsize-smaller.lineheight-tighter.u-marginbottom-20', 'Reward'), m$1('.fontsize-smallest.lineheight-looser', reward.id ? ['ID: ' + reward.id, m$1('en'), 'Minimum value: $' + h.formatNumber(reward.minimum_value, 2, 3), m$1('en'), m$1.trust('Available: ' + available + ' / ' + (reward.maximum_contributions || '&infin;')), m$1('en'), 'Waiting confirmation: ' + reward.waiting_payment_count, m$1('en'), 'Description: ' + reward.description] : 'Support without reward')]);
    }
};
    ...
    view: function view(ctrl, args) {
        ...
        if (collection.loader() || collection.collection().length > 0) {
            return m$1(wrapper, [m$1('.w-container', [!_$1.isUndefined(collection.title) || !_$1.isUndefined(collection.hash) ? m$1('.w-row.u-marginbottom-30', [m$1(showFriends ? '.w-col.w-col-8.w-col-small-6.w-col-tiny-6' : '.w-col.w-col-10.w-col-small-6.w-col-tiny-6', [m$1('.fontsize-large.lineheight-looser', title)]), m$1(showFriends ? '.w-col.w-col-4.w-col-small-6.w-col-tiny-6' : '.w-col.w-col-2.w-col-small-6.w-col-tiny-6', [m$1('.w-row', [showFriends ? m$1('.w-col.w-col-6', [m$1('a.btn.btn-no-border.btn-small.btn-terciary[href="/connect-facebook?ref=' + ref + '"]', 'Meet friends')]) : '', m$1(showFriends ? '.w-col.w-col-6' : '.w-col.w-col-12', m$1('a.btn.btn-small.btn-terciary[href="/explore?ref=' + ref + '&filter=' + collection.hash + '"]', {
                config: m$1.route
            }, I18n$1.t('index.see_all', I18nScope$1())))])])]) : '', collection.loader() ? h.loader() : m$1('.w-row', _$1.map(collection.collection(), function (project) {
...
var Flex = {
    ...
    view: function view(ctrl, args) {
        ...
        })])])])]), m$1('.w-section.section-large.u-text-center.bg-purple', [m$1('.w-container.fontcolor-negative', [m$1('.fontsize-largest', 'Enter your project!'), m$1('.fontsize-base.u-marginbottom-60', 'Register your email and learn how to register your project on flex!'), m$1('.w-row', [m$1('.w-col.w-col-2'), m$1.component(landingSignup, {
            builder: ctrl.builder
        }), m$1('.w-col.w-col-2')])])]), m$1('.w-section.section-one-column.bg-catarse-zelo.section-large[style="min-height: 50vh;"]', [m$1('.w-container.u-text-center', [m$1('.w-editable.u-marginbottom-40.fontsize-larger.lineheight-tight.fontcolor-negative', 'Flex is an experiment and initiative of Citizen Supported, Nepal`s largest crowdfunding platform.'), m$1('.w-row.u-text-center', ctrl.statsLoader() ? h.loader() : [m$1('.w-col.w-col-4', [m$1('.fontsize-jumbo.text-success.lineheight-loose', h.formatNumber(stats.total_contributors, 0, 3)), m$1('p.start-stats.fontsize-base.fontcolor-negative', 'People have already supported at least 01 project in Citizen Supported')]), m$1('.w-col.w-col-4', [m$1('.fontsize-jumbo.text-success.lineheight-loose', h.formatNumber(stats.total_projects_success, 0, 3)), m$1('p.start-stats.fontsize-base.fontcolor-negative', 'Projects have already been funded in Citizen Supported')]), m$1('.w-col.w-col-4', [m$1('.fontsize-jumbo.text-success.lineheight-loose', stats.total_contributed.toString().slice(0, 2) + ' millions'), m$1('p.start-stats.fontsize-base.fontcolor-negative', 'They were invested in ideas published in Citizen Supported')])])])]), m$1('.w-section.section.bg-blue-one.fontcolor-negative', [m$1('.w-container', [m$1('.fontsize-large.u-text-center.u-marginbottom-20', 'Recommend the Citizen Supported flex for friends! '), m$1('.w-row', [m$1('.w-col.w-col-2'), m$1('.w-col.w-col-8', [m$1('.w-row', [m$1('.w-col.w-col-6.w-col-small-6.w-col-tiny-6.w-sub-col-middle', [m$1('div', [m$1('img.icon-share-mobile[src=\'https://daks2k3a4ib2z.cloudfront.net/54b440b85608e3f4389db387/53a3f66e05eb6144171d8edb_facebook-xxl.png\']'), m$1('a.w-button.btn.btn-large.btn-fb[href="http://www.facebook.com/sharer/sharer.php?u=https://www.citizensupported.org/flex?ref=facebook&title=' + encodeURIComponent('Meet the new Citizen Supported Flex!') + '"][target="_blank"]', 'To share')])]), m$1('.w-col.w-col-6.w-col-small-6.w-col-tiny-6', [m$1('div', [m$1('img.icon-share-mobile[src=\'https://daks2k3a4ib2z.cloudfront.net/54b440b85608e3f4389db387/53a3f65105eb6144171d8eda_twitter-256.png\']'), m$1('a.w-button.btn.btn-large.btn-tweet[href="https://twitter.com/intent/tweet?text=' + encodeURIComponent('Let`s build a new mode of crowdfunding for Citizen Supported! Join us, sign up for your email!') + 'https://www.citizensupported.org/flex?ref=twitter"][target="_blank"]', 'To tweet')])])])]), m$1('.w-col.w-col-2')])])]), m$1('.w-section.section-large.bg-greenlime', [m$1('.w-container', [m$1('#participe-do-debate.u-text-center', { config: h.toAnchor() }, [m$1('h1.fontsize-largest.fontcolor-negative', 'Build Flex with us'), m$1('.fontsize-base.u-marginbottom-60.fontcolor-negative', 'Start a conversation, ask, comment, critique and make suggestions!')]), m$1('#disqus_thread.card.u-radius[style="min-height: 50vh;"]', {
...
var cancelProjectModalContent = {
    ...
    view: function view(ctrl, args) {
        return m$1('form.cancel-project-modal.modal-dialog-content', { onsubmit: ctrl.showNextModal }, [m$1('.fontsize-small.u-marginbottom-20', ['Upon cancellation, your campaign will appear on the platform as "non-funded" and your supporters will be immediately reimbursed. ', m$1('span.fontweight-semibold', 'This action cannot be undone!'), m$1('en'), m$1('span.fontweight-semibold')]), m$1('.fontsize-small.u-marginbottom-10', ['If you are sure you want to cancel your project, please confirm by writing ', m$1('span.fontweight-semibold.text-error', 'cancelar-projeto '), 'in the field below. Then we will ask you to write a message to your supporters and your project will then be canceled.', m$1('span.fontweight-semibold.text-error')]), m$1('.w-form', [m$1('input.positive.text-field.u-marginbottom-40.w-input[maxlength=\'256\'][type=\'text\']', { class: !ctrl.checkError() ? false : 'error', placeholder: 'cancelar-projeto', onchange: m$1.withAttr('value', ctrl.check) })]), m$1('div', m$1('.w-row', [m$1('.w-col.w-col-3'), m$1('.u-text-center.w-col.w-col-6', [m$1('input.btn.btn-inactive.btn-large.u-marginbottom-20[type=\'submit\'][value=\'Next step >\']'), m$1('a.fontsize-small.link-hidden-light[href=\'#\']', { onclick: args.displayModal.toggle }, 'Cancel')]), m$1('.w-col.w-col-3')]))]);
    }
};
...
var successfulProjectTaxModal = {
    view: function view(ctrl, args) {
        var en = args.projectTransfer;

        return m$1('div', [m$1('.modal-dialog-header', [m$1('.fontsize-large.u-text-center', 'Project Extract')]), m$1('.modal-dialog-content', [m$1('p.fontsize-small.u-marginbottom-40', ['Check the extract of your project, including the fees and retentions. If you have questions about how this calculation is done, ', m$1('a.alt-link[href="http://suporte.citizensupported.org/hc/pt-br/articles/202037493-FINANCIADO-Como-ser%C3%A1-feito-o-repasse-do-dinheiro-"][target="__blank"]', 'Access here'), '.']), m$1('div', [m$1('.w-row.fontsize-small.u-marginbottom-10', [m$1('.w-col.w-col-4', [m$1('.text-success', '+\xA0$ ' + h.formatNumber(en.pledged, 2))]), m$1('.w-col.w-col-8', [m$1('div', 'Total collection (' + en.total_contributions + ' Supports)')])]), en.irrf_tax > 0 ? m$1('.w-row.fontsize-small.u-marginbottom-10', [m$1('.w-col.w-col-4', [m$1('.text-success', '+ $ ' + h.formatNumber(en.irrf_tax, 2))]), m$1('.w-col.w-col-8', [m$1('div', 'Retention IRRF (Income Tax withholding)')])]) : '', m$1('.w-row.fontsize-small.u-marginbottom-10', [m$1('.w-col.w-col-4', [m$1('.text-error', '- $ ' + h.formatNumber(en.catarse_fee, 2))]), m$1('.w-col.w-col-8', [m$1('div', 'Citizen Supported fee and means of payment (' + h.formatNumber(en.service_fee * 100, 2) + '%)\xA0')])]), m$1('.divider.u-marginbottom-10'), m$1('.w-row.fontsize-base.fontweight-semibold', [m$1('.w-col.w-col-4', [m$1('div', '$ ' + h.formatNumber(en.total_amount, 2))]), m$1('.w-col.w-col-8', [m$1('div', 'Total to be transferred')])])])])]);
    }
};
...
var insights = {
    controller: function controller(args) {
        ...
        var contributionsPerLocationTable = [['state', 'Support', '$ Supported (% Of total)']];
        var buildPerLocationTable = function buildPerLocationTable(contributions) {
            return !_$1.isEmpty(contributions) ? _$1.map(_$1.first(contributions).source, function (contribution) {
                ...
                m$1('input[type="hidden"][value="' + contribution.total_contributed + '"'), '$ ', h.formatNumber(contribution.total_contributed, 2, 3), m$1('span.w-hidden-small.w-hidden-tiny', ' (' + contribution.total_on_percentage.toFixed(2) + '%)')]]);
        ...
        var buildPerRefTable = function buildPerRefTable(contributions) {
            return !_$1.isEmpty(contributions) ? _$1.map(_$1.first(contributions).source, function (contribution) {
                ...
                column.push([contribution.total_amount, [m$1('input[type="hidden"][value="' + contribution.total_contributed + '"'), '$ ', h.formatNumber(contribution.total_amount, 2, 3), m$1('span.w-hidden-small.w-hidden-tiny', ' (' + contribution.total_on_percentage.toFixed(2) + '%)')]]);
...
var projectContributionReportContentCard = {
    ...
    view: function view(ctrl, args) {
        ...
        return m$1('.w-clearfix.card', [m$1('.w-row', [m$1('.w-col.w-col-1.w-col-tiny-1', [m$1('img.user-avatar.u-marginbottom-10[src=\'' + profile_img + '\']')]), m$1('.w-col.w-col-11.w-col-tiny-11', [m$1('.w-row', [m$1('.w-col.w-col-3', [m$1('.fontcolor-secondary.fontsize-mini.fontweight-semibold', h.momentify(contribution.created_at, 'DD/MM/YYYY, HH:mm')), m$1('.fontweight-semibold.fontsize-smaller.lineheight-tighter', contribution.user_name), m$1('.fontsize-smallest.lineheight-looser', [contribution.has_another ? [m$1('a.link-hidden-light.badge.badge-light', '+1 apoio ')] : '', contribution.anonymous ? m$1('span.fa.fa-eye-slash.fontcolor-secondary', m$1('span.fontcolor-secondary[style="font-size:11px;"]', ' Non-public support')) : '']), m$1('.fontsize-smallest.lineheight-looser', contribution.email)]), m$1('.w-col.w-col-3', [m$1('.lineheight-tighter', [m$1('span.fa.fontsize-smallest.' + ctrl.stateClass(contribution.state)), '   ', m$1('span.fontsize-large', '$ ' + h.formatNumber(contribution.value, 2, 3))])]), m$1('.w-col.w-col-3.w-hidden-small.w-hidden-tiny', [m$1('.fontsize-smallest.fontweight-semibold', 'Reward:\xA0$ ' + h.formatNumber(reward.minimum_value, 2, 3)), m$1('.fontsize-smallest', reward.description.substring(0, 80) + '...')]) /*,
        ...
        var mapRewardsToOptions = function mapRewardsToOptions() {
            ...
            if (!lReward()) {
                options = _$1.map(rewards(), function (r) {
                    return {
                        value: r.id,
                        option: '$ ' + h.formatNumber(r.minimum_value, 2, 3) + ' - ' + r.description.substring(0, 20)
                    };
                });
            }
...
var search = {
    view: function view(ctrl) {
        ...
        var action = args.action || '/explore?ref=ctrse_explore_pgsearch',
...
var UnsignedFriendFacebookConnect = {
    ...
    view: function view(ctrl, args) {
        return m$1('.w-section.section' + (ctrl.largeBg ? '.bg-backs-carrosel.section-large' : ''), [m$1('.w-container', [m$1('.card.card-big', [m$1('.w-row', [m$1('.w-col.w-col-8', [m$1('.fontsize-largest.u-marginbottom-20', 'Find amazing projects with your friends'), m$1('.fontsize-small', 'Using your Facebook network to explore Citizen Supported will help you discover incredible projects!')]), m$1('.w-col.w-col-4', [m$1('a.w-button.btn.btn-fb.btn-large.u-margintop-30.u-marginbottom-10[href="/connect-facebook"]', 'Connect your facebook'), m$1('.fontsize-smallest.fontcolor-secondary.u-text-center', 'We will never post anything on facebook without your permission')])])])])]);
    }
};
...
var menuProfile = {
    ...
    view: function view(ctrl, args) {
        ...
        }, [m$1('.user-name-menu', ctrl.userName()), m$1('img.user-avatar[alt=\'Thumbnail - ' + user.name + '\'][height=\'40\'][src=\'' + h.useAvatarOrDefault(user.profile_img_thumbnail) + '\'][width=\'40\']')]), ctrl.toggleMenu() ? m$1('nav.w-dropdown-list.dropdown-list.user-menu.w--open[id=\'user-menu-dropdown\']', { style: 'display:block;' }, [m$1('.w-row', [m$1('.w-col.w-col-12', [m$1('.fontweight-semibold.fontsize-smaller.u-marginbottom-10', 'My history'), m$1('ul.w-list-unstyled.u-marginbottom-20', [m$1('li.lineheight-looser', m$1('a.alt-link.fontsize-smaller[href=\'/users/' + user.id + '/edit#contributions\']', 'Support history')), m$1('li.lineheight-looser', m$1('a.alt-link.fontsize-smaller[href=\'/users/' + user.id + '/edit#projects\']', 'Projects created')), m$1('li.w-hidden-main.w-hidden-medium.lineheight-looser', m$1('a.alt-link.fontsize-smaller[href=\'/users/' + user.id + '/edit#projects\']', 'Projects created'))]), m$1('.fontweight-semibold.fontsize-smaller.u-marginbottom-10', 'Settings'), m$1('ul.w-list-unstyled.u-marginbottom-20', [m$1('li.lineheight-looser', m$1('a.alt-link.fontsize-smaller[href=\'/users/' + user.id + '/edit#about_me\']', 'About you')), m$1('li.lineheight-looser', m$1('a.alt-link.fontsize-smaller[href=\'/users/' + user.id + '/edit#notifications\']', 'Notifications')), m$1('li.lineheight-looser', m$1('a.alt-link.fontsize-smaller[href=\'/users/' + user.id + '/edit#settings\']', 'Information & address')), m$1('li.lineheight-looser', m$1('a.alt-link.fontsize-smaller[href=\'/users/' + user.id + '/edit#billing\']', 'Bank & payment info'))]), m$1('.divider.u-marginbottom-20'), args.user.is_admin_role ? m$1('.fontweight-semibold.fontsize-smaller.u-marginbottom-10', 'Admin') : '', args.user.is_admin_role ? m$1('ul.w-list-unstyled.u-marginbottom-20', [m$1('li.lineheight-looser', m$1('a.alt-link.fontsize-smaller[href=\'/new-admin#/users\']', 'Users')), m$1('li.lineheight-looser', m$1('a.alt-link.fontsize-smaller[href=\'/new-admin\']', 'Support')), m$1('li.lineheight-looser', m$1('a.alt-link.fontsize-smaller[href=\'/admin/financials\']', 'Financial relations')), m$1('li.lineheight-looser', m$1('a.alt-link.fontsize-smaller[href=\'/admin/projects\']', 'Administer projects')), m$1('li.lineheight-looser', m$1('a.alt-link.fontsize-smaller[href=\'/dbhero\']', 'Dataclips'))]) : '', m$1('.fontsize-mini', 'Your email address is: '), m$1('.fontsize-smallest.u-marginbottom-20', [m$1('span.fontweight-semibold', user.email + ' '), m$1('a.alt-link[href=\'/users/' + user.id + '/edit#settings\']', 'change email')]), m$1('.divider.u-marginbottom-20'), m$1('a.alt-link[href=\'/logout\']', 'Logout')])])]) : '']);
    }
};

var I18nScope$16 = _$1.partial(h.i18nScope, 'layouts');
...
var menu = {
    ...
    view: function view(ctrl, args) {
        return m$1('header.main-header', {
            class: ctrl.menuCss()
        }, [m$1('.w-row', [m$1('.w-clearfix.w-col.w-col-8.w-col-small-8.w-col-tiny-8', [m$1('a.header-logo.w-inline-block[href=\'/?ref=ctrse_header\'][title=\'Citizen Supported\']', ctrl.homeAttrs(), m$1('img[alt=\'Logo big\'][src=\'/assets/catarse_bootstrap/logo_big.png\']')), args.menuShort ? '' : m$1('div#menu-components', [m$1('a.w-hidden-small.w-hidden-tiny.header-link.w-nav-link[href=\'/start?ref=ctrse_header\']', { config: m$1.route }, I18n$1.t('header.submit', I18nScope$16())), m$1('a.w-hidden-small.w-hidden-tiny.header-link.w-nav-link[href=\'/explore?ref=ctrse_header\']', { config: m$1.route }, 'Explore'), m$1.component(menuSearch)])]), m$1('.text-align-right.w-col.w-col-4.w-col-small-4.w-col-tiny-4', [ctrl.user ? m$1.component(menuProfile, { user: ctrl.user }) : m$1('div#signin-components', [m$1('a.w-nav-link.header-link.w-nav-link.btn-edit.u-right[href=\'/login?ref=ctrse_header\']', I18n$1.t('header.signin', I18nScope$16())), m$1('a.w-nav-link.header-link.header-link.w-nav-link.u-right[href=\'/sign_up?ref=ctrse_header\']', I18n$1.t('header.signup', I18nScope$16()))])])]), args.menuShort ? '' : m$1('.header-controls-mobile.w-hidden-main.w-hidden-medium', [m$1('a.header-link.w-nav-link[href=\'/start?ref=ctrse_header\']', { onclick: function onclick() {
                return m$1.route('/start');
            } }, I18n$1.t('header.submit', I18nScope$16())), m$1('a.header-link.w-nav-link[href=\'/explore?ref=ctrse_header\']', { onclick: function onclick() {
...
var footer = {
    view: function view() {
        return m$1('footer.main-footer.main-footer-neg', [m$1('section.w-container', m$1('.w-row', [m$1('.w-col.w-col-9', m$1('.w-row', [m$1('.w-col.w-col-4.w-col-small-4.w-col-tiny-4.w-hidden-tiny', [m$1('.footer-full-signature-text.fontsize-small', 'Welcome'), m$1('a.link-footer[href=\'http://www.citizensupported.org/start?ref=citizensupported_footer\']', ['How it works', m$1.trust('&nbsp;'), m$1('span.badge.badge-success', 'New‍')]), m$1('a.link-footer[href=\'https://www.citizensupported.org/team?ref=citizensupported_footer\']', [' Our team ', m$1.trust('&lt;'), '3']), m$1('a.link-footer[href=\'https://www.citizensupported.org/jobs\']', [' Jobs', m$1.trust('&nbsp;'), m$1('span.badge.badge-success', 'New‍')]), m$1('a.link-footer[href=\'http://facebook.com/citizensupported\']', ' Facebook'), m$1('a.link-footer[href=\'http://twitter.com/citznsupported\']', ' Twitter'), m$1('a.link-footer[href=\'http://instagram.com/citizensupported\']', ' Instagram'), m$1('a.link-footer[href=\'http://github.com/citizensupported/citizensupported\']', ' Github'), m$1('a.link-footer[href=\'http://blog.citizensupported.org\']', ' Blog')]), m$1('.w-col.w-col-4.w-col-small-4.w-col-tiny-4.footer-full-firstcolumn', [m$1('.footer-full-signature-text.fontsize-small', 'Help'), m$1('a.link-footer[href=\'https://citizensupported.zendesk.com/hc/en-us/requests/new\'][target="_BLANK"]', ' Contact'), m$1('a.link-footer[href=\'https://www.citizensupported.org/press?ref=citizensupported_footer\']', ' Press'), m$1('a.link-footer[href=\'https://citizensupported.zendesk.com/hc/en-us/community/topics?ref=citizensupported_footer/\']', ' Support Center'), m$1('a.link-footer[href=\'/terms-of-use\']', ' Terms of Use'), m$1('a.link-footer[href=\'/privacy-policy\']', ' Privacy Policy')]), m$1('.w-col.w-col-4.w-col-small-4.w-col-tiny-4.footer-full-lastcolumn', [m$1('.footer-full-signature-text.fontsize-small', 'Browse'), m$1('a.w-hidden-small.w-hidden-tiny.link-footer[href=\'/start?ref=citizensupported_footer\']', ' Fund your activism'), m$1('a.link-footer[href=\'/explore?ref=citizensupported_footer\']', ' Explore protests'), m$1('a.w-hidden-main.w-hidden-medium.w-hidden-small.link-footer[href=\'http://blog.citizensupported.org?ref=citizensupported_footer\']', ' Blog'), m$1('a.w-hidden-main.w-hidden-medium.w-hidden-small.link-footer[href=\'https://equipecatarse.zendesk.com/account/dropboxes/20298537\']', ' Contact'), m$1('a.w-hidden-tiny.link-footer[href=\'/explore?filter=score&ref=citizensupported_footer\']', ' Popular'), m$1('a.w-hidden-tiny.link-footer[href=\'/explore?filter=online&ref=citizensupported_footer\']', ' Just started'), m$1('a.w-hidden-tiny.link-footer[href=\'/explore?filter=finished&ref=citizensupported_footer\']', ' Finished')])])), m$1('.w-col.w-col-3.column-social-media-footer', [m$1('.footer-full-signature-text.fontsize-small', 'Subscribe to our news'), m$1('.w-form', m$1('form[accept-charset=\'UTF-8\'][action=\'' + h.getMailchimpUrl() + '\'][id=\'mailee-form\'][method=\'post\']', [m$1('.w-form.footer-newsletter', m$1('input.w-input.text-field.prefix[id=\'EMAIL\'][label=\'email\'][name=\'EMAIL\'][placeholder=\'Type your email\'][type=\'email\']')), m$1('button.w-inline-block.btn.btn-edit.postfix.btn-attached[style="padding:0;"]', m$1('img.footer-news-icon[alt=\'Icon newsletter\'][src=\'/assets/catarse_bootstrap/icon-newsletter.png\']'))])), m$1('.footer-full-signature-text.fontsize-small', 'Social Networks'), m$1('.w-widget.w-widget-facebook.u-marginbottom-20', m$1('.facebook', m$1('.fb-like[data-colorscheme=\'dark\'][data-href=\'http://facebook.com/citizensupported\'][data-layout=\'button_count\'][data-send=\'false\'][data-show-faces=\'false\'][data-title=\'\'][data-width=\'260\']'))), m$1('.w-widget.w-widget-twitter', [m$1('a.twitter-follow-button[href="http://twitter.com/citznsupported"][data-button="blue"][data-text-color="#FFFFFF][data-link-color="#FFFFFF"][data-width="224px"]')]), m$1('.u-margintop-30', [m$1('.footer-full-signature-text.fontsize-small', 'Change language'), m$1('[id=\'google_translate_element\']')])])])), m$1('.w-container', m$1('.footer-full-copyleft', [m$1('img.u-marginbottom-20[alt=\'Logo footer\'][src=\"/assets/catarse_bootstrap/logo_big.png\"]'), m$1('.lineheight-loose', m$1('a.link-footer-inline[href=\'http://github.com/citizensupported/citizensupported\']', 'Made with love | 2016 | Open source'))]))]);
    }
};
...
var projectsHome = {
    ...
    view: function view(ctrl) {
        ...
        return m$1('#projects-home-component', { config: h.setPageTitle(I18n$1.t('header_html', I18nScope$15())) }, [
...
var projectShareBox = {
    ...
    view: function view(ctrl, args) {
        ...
        }, '< embed >'), ctrl.displayEmbed() ? m$1('.embed-expanded.u-margintop-30', [m$1('.fontsize-small.fontweight-semibold.u-marginbottom-20', 'Insert a widget on your site'), m$1('.w-form', [m$1('input.w-input[type="text"][value="<iframe frameborder="0" height="340px" src="https://www.citizensupported.org/projects/' + args.project().project_id + '/embed" width="300px" scrolling="no"></iframe>"]')]), m$1('.card-embed', [m$1('iframe[frameborder="0"][height="350px"][src="/projects/' + args.project().project_id + '/embed"][width="300px"][scrolling="no"]')])]) : '', args.project().permalink ? m$1.component(facebookButton, {
            mobile: true,
...
var addressTag = {
    view: function view(ctrl, args) {
        ...
        return !_.isNull(address) ? m$1('a.btn.btn-inline.btn-small.btn-transparent.link-hidden-light.u-marginbottom-10[href="/explore?pg_search=' + address.state_acronym + '"]', {
...
var categoryTag = {
    view: function view(ctrl, args) {
        ...
        return project ? m$1('a.btn.btn-inline.btn-small.btn-transparent.link-hidden-light[href="/explore#by_category_id/' + project().category_id + '"]', {
            onclick: h.analytics.event({
                cat: 'project_view',
...
var projectMode = {
    view: function view(ctrl, args) {
        ...
        return m$1('#' + mode + '.w-row', [m$1('.w-col.w-col-2.w-col-small-2.w-col-tiny-2', [!_$1.isEmpty(project) ? m$1('img[src="' + modeImgSrc + '"][width=\'30\']') : '']), m$1('.w-col.w-col-10.w-col-small-10.w-col-tiny-10', [m$1('.fontsize-base.fontweight-semibold', 'Goal $ ' + h.selfOrEmpty(goal, '--')), m$1('.w-inline-block.fontsize-smallest._w-inline-block', [!_$1.isEmpty(project) ? modeTitle : '', buildTooltip('span.w-inline-block.tooltip-wrapper.fa.fa-question-circle.fontcolor-secondary')])])]);
    }
};
...
var ownerMessageContent = {
    ...
    view: function view(ctrl, args) {
        var successMessage = m$1('.modal-dialog-content.u-text-center', [m$1('.fa.fa-check-circle.fa-5x.text-success.u-marginbottom-40'), m$1('p.fontsize-large', 'Your message was successfully sent to ' + ctrl.userDetails().name + '. You will receive a copy in your email and you can follow the conversation there!')]),
            ...
            return m$1('span.fontsize-smallest.text-error', [m$1('span.fa.fa-exclamation-triangle'), ' ' + errors.message, m$1('en')]);
...
var I18nScope$18 = _$1.partial(h.i18nScope, 'projects.project_sidebar');
...
var projectSidebar = {
    ...
    view: function view(ctrl, args) {
        var project = args.project,
            ...
            var states = {
                'approved': I18n$1.t('display_status.approved', I18nScope$18()),
                'online': h.existy(project().zone_expires_at) && project().open_for_contributions ? I18n$1.t('display_status.online', I18nScope$18({ date: h.momentify(project().zone_expires_at) })) : '',
                'failed': I18n$1.t('display_status.failed', I18nScope$18({ date: h.momentify(project().zone_expires_at), goal: project().goal })),
                'rejected': I18n$1.t('display_status.rejected', I18nScope$18()),
                'in_analysis': I18n$1.t('display_status.in_analysis', I18nScope$18()),
                'successful': I18n$1.t('display_status.successful', I18nScope$18({ date: h.momentify(project().zone_expires_at) })),
                'waiting_funds': I18n$1.t('display_status.waiting_funds', I18nScope$18()),
                'draft': I18n$1.t('display_status.draft', I18nScope$18())
            };

            return states[project().state];
        };

        return m$1('#project-sidebar.aside', [m$1('.project-stats', [m$1('.project-stats-inner', [m$1('.project-stats-info', [m$1('.u-marginbottom-20', [m$1('#pledged.fontsize-largest.fontweight-semibold.u-text-center-small-only', '$ ' + (project().pledged ? h.formatNumber(project().pledged) : '0')), m$1('.fontsize-small.u-text-center-small-only', [I18n$1.t('contributors_call', I18nScope$18()), m$1('span#contributors.fontweight-semibold', I18n$1.t('contributors_count', I18nScope$18({ count: project().total_contributors }))), !project().expires_at && elapsed ? ' in ' + I18n$1.t('datetime.distance_in_words.x_' + elapsed.unit, { count: elapsed.total }, I18nScope$18()) : ''])]), m$1('.meter', [m$1('#progressBar.meter-fill', {
            style: {
                width: project().progress + '%'
            }
        })]), m$1('.w-row.u-margintop-10', [m$1('.w-col.w-col-5.w-col-small-6.w-col-tiny-6', [m$1('.fontsize-small.fontweight-semibold.lineheight-tighter', (project().progress ? parseInt(project().progress) : '0') + '%')]), m$1('.w-col.w-col-7.w-col-small-6.w-col-tiny-6.w-clearfix', [m$1('.u-right.fontsize-small.lineheight-tighter', remaining && remaining.total ? [m$1('span.fontweight-semibold', remaining.total), I18n$1.t('remaining_time.' + remaining.unit, I18nScope$18({ count: remaining.total }))] : '')])])]), m$1('.w-row', [m$1.component(projectMode, {
            project: project
        ...
        }, I18n$1.t('submit', I18nScope$18()))]), m$1('.back-project-btn-row-right', m$1.component(projectReminder, {
            project: project,
            type: 'link'
...
var userContributionDetail = {
    ...
    view: function view(ctrl, args) {
        ...
        return m$1('.user-contribution-detail', [m$1('.w-col.w-col-4', [m$1('.fontsize-smallest.lineheight-tight.fontweight-semibold.u-marginbottom-10', 'Value of support:'), m$1('.fontsize-large', '$' + contribution.value)]), m$1('.w-col.w-col-4', m$1.component(paymentStatus, { item: contribution })), m$1('.w-col.w-col-4', [m$1('.fontsize-smaller.fontweight-semibold.u-marginbottom-10', 'Reward:'), m$1('.fontsize-smallest.lineheight-tight.u-marginbottom-20', !_$1.isUndefined(ctrl.chosenReward) ? ctrl.chosenReward.description : 'No reward selected.'), m$1('.fontsize-smallest.lineheight-looser', !_$1.isUndefined(ctrl.chosenReward) ? [m$1('span.fontweight-semibold', 'Estimated delivery: '), h.momentify(ctrl.chosenReward.deliver_at, 'MMM/YYYY')] : '')])]);
    }
};
...
var projectRewardList = {
    ...
    view: function view(ctrl, args) {
        ...
        return m$1('#rewards.u-marginbottom-30', _$1.map(args.rewardDetails(), function (reward) {
            ...
            }, [reward.minimum_value >= 100 ? m$1('.tag-circle-installment', [m$1('.fontsize-smallest.fontweight-semibold.lineheight-tightest', '3x'), m$1('.fontsize-mini.lineheight-tightest', 's/ interest')]) : '', m$1('.u-marginbottom-20', [m$1('.fontsize-base.fontweight-semibold', 'For $ ' + h.formatNumber(reward.minimum_value) + ' or more'), m$1('.fontsize-smaller.fontweight-semibold', h.pluralize(reward.paid_count, ' contribution', ' contributions')), reward.maximum_contributions > 0 ? [reward.waiting_payment_count > 0 ? m$1('.maximum_contributions.in_time_to_confirm.clearfix', [m$1('.pending.fontsize-smallest.fontcolor-secondary', h.pluralize(reward.waiting_payment_count, ' contribution in confirmation period', ' contributions in confirmation period....'))]) : '', h.rewardSouldOut(reward) ? m$1('.u-margintop-10', [m$1('span.badge.badge-gone.fontsize-smaller', 'Out of stock')]) : m$1('.u-margintop-10', [m$1('span.badge.badge-attention.fontsize-smaller', [m$1('span.fontweight-bold', 'Limited'), project.open_for_contributions ? ' (' + h.rewardRemaning(reward) + ' out of ' + reward.maximum_contributions + ' available)' : ''])])] : '']), m$1('.fontsize-smaller.u-margintop-20', m$1.trust(h.simpleFormat(h.strip(reward.description)))), !_$1.isEmpty(reward.deliver_at) ? m$1('.fontsize-smaller', [m$1('b', 'Estimated Delivery: '), h.momentify(reward.deliver_at, 'MMM/YYYY')]) : '', project.open_for_contributions && !h.rewardSouldOut(reward) ? [ctrl.openedReward().id === reward.id ? m$1('.w-form', [m$1('form.u-margintop-30', {
                onsubmit: ctrl.submitContribution
            }, [m$1('.divider.u-marginbottom-20'), m$1('.fontcolor-secondary.u-marginbottom-10', 'Value of contribution'), m$1('.w-row.u-marginbottom-20', [m$1('.w-col.w-col-3.w-col-small-3.w-col-tiny-3', m$1('.back-reward-input-reward.placeholder', '$')), m$1('.w-col.w-col-9.w-col-small-9.w-col-tiny-9', m$1('input.w-input.back-reward-input-reward[type="tel"]', {
                config: ctrl.setInput,
                onkeyup: m$1.withAttr('value', ctrl.applyMask),
                value: ctrl.contributionValue()
            }))]), m$1('input.w-button.btn.btn-medium[type="submit"][value="Continue >"]'), ctrl.error().length > 0 ? m$1('.text-error', [m$1('en'), m$1('span.fa.fa-exclamation-triangle'), ' ' + ctrl.error()]) : ''])]) : ''] : '']);
        }));
    }
};
...
var projectSuggestedContributions = {
    view: function view(ctrl, args) {
        ...
        return m$1('#suggestions', _$1.map(suggestedValues, function (amount) {
            return project ? m$1('a[href="' + suggestionUrl(amount) + '"].card-reward.card-big.card-secondary.u-marginbottom-20', [m$1('.fontsize-larger', '$\xA0' + amount)]) : '';
        }));
    }
};
...
var projectContributions$1 = {
    controller: function controller(args) {
        ...
        var contributionsPerLocationTable = [['state', 'Backed', '$ backed (% Of total)']];
        var buildPerLocationTable = function buildPerLocationTable(contributions) {
            return !_$1.isEmpty(contributions) ? _$1.map(_$1.first(contributions).source, function (contribution) {
                var column = [];
...
var projectComments = {
    ...
    view: function view(ctrl, args) {
        var project = args.project();
        return m$1('.w-row', [m$1('.w-col.w-col-7', m$1('.fb-comments[data-href="http://www.citizensupported.org/' + project.permalink + '"][data-num-posts=50][data-width="610"]', { config: ctrl.loadComments() })), m$1('.w-col.w-col-5', m$1.component(projectReport))]);
    }
};
...
var projectPosts = {
    ...
    view: function view(ctrl, args) {
        ...
        return m$1('.project-posts.w-section', [m$1('.w-container.u-margintop-20', [project.is_owner_or_admin ? [!list.isLoading() ? _$1.isEmpty(list.collection()) ? m$1('.w-hidden-small.w-hidden-tiny', [m$1('.fontsize-base.u-marginbottom-30.u-margintop-20', 'All news published in the Citizen Supported is sent directly to the email of who has already supported his project and is also available for viewing on the site. You can choose to leave it public, or visible only to your supporters here on this tab.')]) : '' : '', m$1('.w-row.u-marginbottom-20', [m$1('.w-col.w-col-4'), m$1('.w-col.w-col-4', [m$1('a.btn.btn-edit.btn-small[href=\'/projects/' + project.project_id + '/edit#posts\']', 'Writing novelty')]), m$1('.w-col.w-col-4')])] : '', _$1.map(list.collection(), function (post) {
        ...
        }), m$1('.w-row', [!_$1.isUndefined(args.post_id) ? '' : !list.isLoading() ? list.collection().length === 0 && args.projectContributions().length === 0 ? !project.is_owner_or_admin ? m$1('.w-col.w-col-10.w-col-push-1', m$1('p.fontsize-base', m$1.trust(I18n$1.t('empty', I18nScope$19({
...
var usersShow = {
    ...
    view: function view(ctrl, args) {
        ...
        return m$1('div', [m$1.component(userHeader, { user: user }), m$1('nav.project-nav.u-text-center.u-marginbottom-30.profile', { style: { 'z-index': '10', 'position': 'relative' } }, m$1('.w-container[data-anchor=\'created\']', [!_$1.isEmpty(user) ? user.is_owner_or_admin ? m$1('a.dashboard-nav-link.dashboard[href=\'/users/' + user.id + '/edit\']', { config: m$1.route, onclick: function onclick() {
...
var userAboutEdit = {
    ...
    view: function view(ctrl, args) {
        ...
        })), m$1('.w-col.w-col-6.w-col-small-6.w-col-tiny-6.text-field.postfix.no-hover', m$1('.fontcolor-secondary.fontsize-smaller', '  .citizensupported.org'))]))]), m$1('.w-row.u-marginbottom-30.card.card-terciary', [m$1('.w-col.w-col-5.w-sub-col', [m$1('label.field-label.fontweight-semibold', '  Name'), m$1('label.field-label.fontsize-smallest.fontcolor-secondary', '  This is the name that users will see in your public profile.')]), m$1('.w-col.w-col-7', m$1('input.string.optional.w-input.text-field.positive[id="user_name"][type="text"]', {
            name: 'user[name]',
            value: fields.name(),
...
var userSettings = {
    ...
    view: function view(ctrl, args) {
        ...
        }, [m$1('div', [m$1('.w-container', m$1('.w-col.w-col-10.w-col-push-1', m$1('.w-form.card.card-terciary.u-marginbottom-20', [m$1('.fontsize-base.fontweight-semibold', 'Email'), m$1('.fontsize-small.u-marginbottom-30', 'Keep this email up to date as it is the communication channel between you, the Citizen Supported team and the team of projects you have supported. '), m$1('.fontsize-base.u-marginbottom-40', [m$1('span.fontweight-semibold.card.u-radius', user.email), m$1('a.alt-link.fontsize-small.u-marginleft-10[href=\'javascript:void(0);\'][id=\'update_email\']', {
            onclick: function onclick() {
...
var I18nScope$22 = _$1.partial(h.i18nScope, 'projects.contributions.edit.errors');
...
var paymentVM = function paymentVM() {
    ...
    var scope = function scope(data) {
        return isInternational() ? I18nIntScope$1(data) : I18nScope$22(data);
    };
...
var I18nScope$23 = _.partial(h.i18nScope, 'projects.faq');
...
var faqBox = {
        ...
        var scopedQuestions = function scopedQuestions() {
            ...
            _.each(questions, function (quest, idx) {
                _.extend(updatedQuestions, defineProperty({}, idx + 1, {
                    question: I18n$1.t(tKey() + '.questions.' + idx + '.question', I18nScope$23()),
                    answer: I18n$1.t(tKey() + '.questions.' + idx + '.answer', I18nScope$23({ userLink: '/users/' + user().id,
                        userName: user().name
                    }))
                }));
            });
    ...
    view: function view(ctrl, args) {
        ...
        })), m$1('.w-col.w-col-10.w-col-small-10.w-col-tiny-10', m$1('.w-inline-block.fontsize-smallest.w-inline-block.fontcolor-secondary', I18n$1.t(ctrl.tKey() + '.description', I18nScope$23())))]), m$1('.u-marginbottom-20.fontsize-small.fontweight-semibold', I18n$1.t('' + (args.vm.isInternational() ? 'international_title' : 'title'), I18nScope$23())), m$1('ul.w-list-unstyled', _.map(ctrl.scopedQuestions(), function (question, idx) {
...
var I18nScope$25 = _.partial(h.i18nScope, 'projects.contributions.edit.errors');
...
var paymentSlip = {
    ...
    view: function view(ctrl, args) {
        return m$1('.w-row', m$1('.w-col.w-col-12', m$1('.u-margintop-30.u-marginbottom-60.u-radius.card-big.card', [m$1('.fontsize-small.u-marginbottom-20', ctrl.slipPaymentDate() ? 'This bank slip expires on ' + h.momentify(ctrl.slipPaymentDate().slip_expiration_date) + '.' : 'Loading...'), m$1('.fontsize-small.u-marginbottom-40', 'In generating the ticket, the director is already counting on his support. Pay through the internet due date, lottery houses, ATMs or bank branch.'), m$1('.w-row', m$1('.w-col.w-col-8.w-col-push-2', [ctrl.loading() ? h.loader() : ctrl.completed() ? '' : m$1('input.btn.btn-large.u-marginbottom-20', {
            ...
            value: 'Print Ticket',
            type: 'submit'
        }), ctrl.error() ? m$1.component(inlineError, { message: ctrl.error() }) : '', m$1('.fontsize-smallest.u-text-center.u-marginbottom-30', ['By supporting, you agree with the ', m$1('a.alt-link[href=\'/terms-of-use\']', 'Terms of use '), 'e ', m$1('a.alt-link[href=\'/privacy-policy\']', 'privacy policy')])]))])));
    }
};
...
var paymentCreditCard = {
    controller: function controller(args) {
        ...
        var scope = function scope(attr) {
            return vm.isInternational() ? I18nIntScope$3(attr) : I18nScope$26(attr);
        };
    ...
    view: function view(ctrl, args) {
        ...
        return m$1('.w-form.u-marginbottom-40', {
            ...
            return m$1('div#credit-card-record-' + idx + '.w-row.creditcard-records', {
                ...
                return m$1('option[value="' + installment.number + '"]', installment.number + ' X $ ' + installment.amount);
            })))]]);
...
var I18nScope$24 = _.partial(h.i18nScope, 'projects.contributions.edit');
...
var paymentForm = {
    controller: function controller(args) {
        var isSlip = m$1.prop(false),
            ...
            return args.vm.isInternational() ? I18nIntScope$2() : I18nScope$24();
        };
...
var I18nScope$21 = _.partial(h.i18nScope, 'projects.contributions.edit');
...
var projectsPayment = {
    controller: function controller(args) {
        ...
        var scope = function scope(attr) {
            return vm.isInternational() ? I18nIntScope(attr) : I18nScope$21(attr);
        };
    ...
    view: function view(ctrl, args) {
        ...
        }), m$1('label.w-form-label.fontsize-smallest[for=\'anonymous\']', I18n$1.t('fields.anonymous', ctrl.scope()))]), ctrl.vm.fields.anonymous() ? m$1('.card.card-message.u-radius.zindex-10.fontsize-smallest', m$1('div', [m$1('span.fontweight-bold', [I18n$1.t('anonymous_confirmation_title', ctrl.scope()), m$1('en')]), m$1('en'), I18n$1.t('anonymous_confirmation', ctrl.scope())])) : ''])]), m$1('.u-marginbottom-40', m$1('.w-form', [m$1('label.field-label.fontweight-semibold[for=\'street\']', I18n$1.t('fields.street', ctrl.scope())), m$1('input.w-input.text-field[id=\'street\']', {
...
var projectsReward = {
    ...
    view: function view(ctrl, args) {
        ...
        return m$1('#project-rewards', [m$1('.w-section.page-header.u-text-center', [m$1('.w-container', [m$1('h1.fontsize-larger.fontweight-semibold.project-name[itemprop="name"]', h.selfOrEmpty(project().name || project().project_name)), m$1('h2.fontsize-base.lineheight-looser[itemprop="author"]', ['per ', project().user ? project().user.name : project().owner_name ? project().owner_name : ''])])]), m$1('.w-section.header-cont-new', m$1('.w-container', m$1('.fontweight-semibold.lineheight-tight.text-success.fontsize-large.u-text-center-small-only', 'Choose the reward and then the value of the support'))), m$1('.section[id=\'new-contribution\']', m$1('.w-container', m$1('.w-row', [m$1('.w-col.w-col-8', m$1('.w-form.back-reward-form', m$1('form.simple_form.new_contribution', {
            ...
            }), m$1('label.w-form-label.fontsize-base.fontweight-semibold.u-marginbottom-10[for=\'contribution_reward_' + reward.id + '\']', reward.id === -1 ? 'I do not want any reward' : '$ ' + reward.minimum_value + ' or more'), isSelected ? m$1('.w-row.back-reward-money', [m$1('.w-col.w-col-8.w-col-small-8.w-col-tiny-8.w-sub-col-middle.w-clearfix', [m$1('.w-row', [m$1('.w-col.w-col-3.w-col-small-3.w-col-tiny-3', m$1('.back-reward-input-reward.placeholder', '$')), m$1('.w-col.w-col-9.w-col-small-9.w-col-tiny-9', m$1('input.user-reward-value.back-reward-input-reward[autocomplete=\'off\'][type=\'tel\']', {
                class: ctrl.error() ? 'error' : '',
                min: monetaryMinimum,
                placeholder: monetaryMinimum,
                onkeyup: m$1.withAttr('value', ctrl.applyMask),
                value: ctrl.contributionValue()
            }))]), ctrl.error().length > 0 ? m$1('.text-error', [m$1('en'), m$1('span.fa.fa-exclamation-triangle'), ' ' + ctrl.error()]) : '']), m$1('.submit-form.w-col.w-col-4.w-col-small-4.w-col-tiny-4', m$1('button.btn.btn-large', ['Continue  ', m$1('span.fa.fa-chevron-right')]))]) : '', m$1('.back-reward-reward-description', [m$1('.fontsize-smaller.u-marginbottom-10', reward.description), reward.deliver_at ? m$1('.fontsize-smallest.fontcolor-secondary', 'Estimated delivery: ' + h.momentify(reward.deliver_at, 'MMM/YYYY')) : ''])])); //End map return
        })))), m$1('.w-col.w-col-4', m$1.component(faqBox, { mode: ctrl.project().mode, faq: ctrl.faq }))])))]);
    }
};

var I18nScope$27 = _$1.partial(h.i18nScope, 'projects.publish');
...
var publish = {
  ...
  view: function view(ctrl, args) {
    var project = _$1.first(ctrl.projectDetails()),
      ...
      return [m$1('.w-col.w-col-11', [m$1('div', [m$1('span.fontsize-smallest.fontcolor-secondary', '1/9'), ' ', m$1('span.fontweight-semibold', 'FLEX Rules')]), m$1('div', 'You have chosen the flexible campaign. In this way, you will receive all the funds collected from the supporters at the end of the campaign term (discounting the Citizen Supported fee) and must comply with the execution of the project and with the delivery of the rewards offered regardless of how much to collect.')]), m$1('.w-col.w-col-11', [m$1('div', [m$1('span.fontsize-smallest.fontcolor-secondary', '2/9'), ' ', m$1('span.fontweight-semibold', 'Goal of collection')]), m$1('div', 'The goal can not be changed after the project has been published.')]), m$1('.w-col.w-col-11', [m$1('div', [m$1('span.fontsize-smallest.fontcolor-secondary', '3/9'), ' ', m$1('span.fontweight-semibold', 'Rates')]), m$1('div', ['At the end of the campaign, we will charge 13%', m$1('span.fontweight-semibold', 'Total amount collected. ')])]), m$1('.w-col.w-col-11', [m$1('div', [m$1('span.fontsize-smallest.fontcolor-secondary', '4/9'), ' ', m$1('span.fontweight-semibold', 'Campaign deadline')]), m$1('div', 'Once set, the closing period can not be changed. If you started the campaign with the deadline, you must set it during the campaign, and you can leave the campaign open for a maximum of 12 months.')]), m$1('.w-col.w-col-11', [m$1('div', [m$1('span.fontsize-smallest.fontcolor-secondary', '5/9'), ' ', m$1('span.fontweight-semibold', 'Deadline for transfer')]), m$1('div', 'When the deadline for your project comes to an end, you should verify your bank details. After this confirmation, Citizen Supported will deposit into your checking account within 10 business days. The amount deposited will already be considering the 13% discount of the fee.')]), m$1('.w-col.w-col-11', [m$1('div', [m$1('span.fontsize-smallest.fontcolor-secondary', '6/9'), ' ', m$1('span.fontweight-semibold', 'What can and can not change on the project page from publication?')]), [m$1('div', [m$1('span.fontweight-semibold', 'You may not:'), ' Change the type of funding, project name, project URL, category chosen, collection goal, deadline (if you have already defined it), rewards where existing support is available, and registered bank account.\
                    ', m$1('en'), m$1('en'), m$1('span.fontweight-semibold', 'You will be able to: '), 'Edit the content of the project description, change the main campaign video, project image, effect phrase, rewards where there are no supports made, and add new rewards during fundraising.'])]]), m$1('.w-col.w-col-11', [m$1('div', [m$1('span.fontsize-smallest.fontcolor-secondary', '7/9'), ' ', m$1('span.fontweight-semibold', 'Responsibility of Citizen Supported')]), [m$1('div', [m$1('span.fontweight-semibold'), m$1('span.fontweight-semibold', 'Citizen Supported is responsible for:'), ' By the technological development of the platform, attendance of doubts and problems (both of supporters and directors), by hosting the project in the platform and by guaranteeing the security of the financial transactions.\ ', m$1('en'), m$1('en'), m$1('span.fontweight-semibold', 'Citizen Supported is not responsible for:'), ' Financing, dissemination and execution, nor for the delivery of rewards of the projects registered.'])]]), m$1('.w-col.w-col-11', [m$1('div', [m$1('span.fontsize-smallest.fontcolor-secondary', '8/9'), ' ', m$1('span.fontweight-semibold', 'Your responsibilities')]), m$1('div', [m$1('span.fontweight-semibold'), m$1('span.fontweight-semibold'), 'It is your responsibility for all aspects of project formatting, planning and dissemination of the fundraising campaign, mobilizing supporters, executing the project, producing and delivering rewards within the estimated deadline, and communicating with supporters.'])]), m$1('.w-col.w-col-11', [m$1('div', [m$1('span.fontsize-smallest.fontcolor-secondary', '9/9'), ' ', m$1('span', { style: { 'font-weight': ' 600' } }, 'Withdrawals from projects in the air')]), m$1('div', [m$1('span.fontweight-semibold'), 'Citizen Supported reserves the right, in its sole discretion and once notified, to cancel projects and terminate the accounts of PROJECT CREATORS that violate our ', m$1('a.alt-link[href=\'http://suporte.citizensupported.org/hc/pt-br/articles/202387638-Diretrizes-para-cria%C3%A7%C3%A3o-de-projetos\'][target=\'_blank\']', 'Game rules'), ' e ', m$1('a.alt-link[href=\'http://www.citizensupported.org/terms-of-use\'][target=\'_blank\']', 'Terms of use'), '.'])])];
    },
        terms = function terms(project) {
      return [m$1('.w-col.w-col-11', [m$1('div', [m$1('span.fontsize-smallest.fontcolor-secondary', '1/9'), ' ', m$1('span.fontweight-semibold', 'Rules of the All-or-nothing mode')]), m$1('div', ['You chose the all-or-nothing campaign. In this way, you will only receive the funds raised ', m$1('span.fontweight-semibold', 'If it reaches or exceeds the collection goal'), '. Otherwise, all of your supporters will be reimbursed. You will be responsible for delivering the rewards offered if your project reaches the collection goal.'])]), m$1('.w-col.w-col-11', [m$1('div', [m$1('span.fontsize-smallest.fontcolor-secondary', '2/9'), ' ', m$1('span', { style: { 'font-weight': ' 600' } }, 'Goal of collection')]), m$1('div', 'The goal can not be changed after the project has been published.')]), m$1('.w-col.w-col-11', [m$1('div', [m$1('span.fontsize-smallest.fontcolor-secondary', '3/9'), ' ', m$1('span', { style: { 'font-weight': ' 600' } }, 'Rates')]), m$1('div', ['We charge 13% ', m$1('span.fontweight-semibold', 'Total amount collected'), ' For your project if it reaches or exceeds the target within the campaign deadline. If the project does not reach the goal, no fee will be charged.', m$1('span.fontweight-semibold')])]), m$1('.w-col.w-col-11', [m$1('div', [m$1('span.fontsize-smallest.fontcolor-secondary', '4/9'), ' ', m$1('span', { style: { 'font-weight': ' 600' } }, 'Campaign deadline')]), m$1('div', 'Your project will be in collection at the Citizen Supported until the ' + h.momentify(ctrl.expiresAt()) + 'At 11:50 p.m. This deadline can not be changed after the project has been published.')]), m$1('.w-col.w-col-11', [m$1('div', [m$1('span.fontsize-smallest.fontcolor-secondary', '5/9'), ' ', m$1('span', { style: { 'font-weight': ' 600' } }, 'Transfer and refund rules')]), m$1('div', ['When the deadline for your project comes to an end, you should verify your bank details. After this confirmation, Citizen Supported will deposit the amount collected, with the discount of the rate, into your checking account within 10 business days. If the project does not reach 100% of the target by the deadline, the Citizen Supported will reimburse the supporters. ', m$1('a.alt-link[href=\'http://suporte.citizensupported.org/hc/pt-br/articles/202365507\'][target=\'_blank\']', 'Learn more about the refund process'), '.'])]), m$1('.w-col.w-col-11', [m$1('div', [m$1('span.fontsize-smallest.fontcolor-secondary', '6/9'), ' ', m$1('span', { style: { 'font-weight': ' 600' } }, 'What can and can not change on the project page from publication?')]), [m$1('div', [m$1('span.fontweight-semibold', 'You can not:'), ' Change the name of the project, the URL (link) of the project, the category chosen, the type of financing, the bank account, the collection goal, the term chosen and the rewards where existing support already exists.\ ', m$1('en'), m$1('en'), m$1('span.fontweight-semibold', 'You will be able to: '), 'Edit the content of the project description, change the main campaign video, project image, effect phrase, rewards where there are no supports made, and add new rewards during fundraising.'])]]), m$1('.w-col.w-col-11', [m$1('div', [m$1('span.fontsize-smallest.fontcolor-secondary', '7/9'), ' ', m$1('span', { style: { 'font-weight': ' 600' } }, 'Responsibility of Citizen Supported')]), [m$1('div', [m$1('span.fontweight-semibold'), m$1('span.fontweight-semibold', 'Citizen Supported is responsible:'), ' By the technological development of the platform, attendance of doubts and problems (both of supporters and directors), by hosting the project in the platform and by guaranteeing the security of the financial transactions.\ ', m$1('en'), m$1('en'), m$1('span.fontweight-semibold', 'Citizen Supported is not responsible for:'), ' Financing, dissemination and execution, nor for the delivery of rewards of the projects registered.'])]]), m$1('.w-col.w-col-11', [m$1('div', [m$1('span.fontsize-smallest.fontcolor-secondary', '8/9'), ' ', m$1('span', { style: { 'font-weight': ' 600' } }, 'Your responsibilities')]), m$1('div', [m$1('span.fontweight-semibold'), m$1('span.fontweight-semibold'), 'It is your responsibility for all aspects of project formatting, planning and dissemination of the fundraising campaign, mobilizing supporters, executing the project, producing and delivering rewards within the estimated deadline, and communicating with supporters.'])]), m$1('.w-col.w-col-11', [m$1('div', [m$1('span.fontsize-smallest.fontcolor-secondary', '9/9'), ' ', m$1('span', { style: { 'font-weight': ' 600' } }, 'Withdrawals from projects in the air')]), m$1('div', [m$1('span.fontweight-semibold'), 'Citizen Supported reserves the right, in its sole discretion and once notified, to cancel projects and terminate the accounts of PROJECT CREATORS that violate our', m$1('a.alt-link[href=\'http://suporte.citizensupported.org/hc/pt-br/articles/202387638-Diretrizes-para-cria%C3%A7%C3%A3o-de-projetos\'][target=\'_blank\']', 'Game rules'), ' e ', m$1('a.alt-link[href=\'http://www.citizensupported.org/terms-of-use\'][target=\'_blank\']', 'Terms of use'), '.'])])];
    };

    return [!ctrl.l() && !ctrl.accountL() ? [project.is_owner_or_admin ? m$1.component(projectDashboardMenu, {
      project: m$1.prop(project),
      hidePublish: true
    }) : '', m$1('.w-section.section-product.' + project.mode), m$1('.w-section.section', [m$1('.w-container', [m$1('.w-row', [m$1('.w-col.w-col-3'), m$1('.w-col.w-col-6', [m$1('.u-text-center', [m$1('img.u-marginbottom-20[src=\'/assets/catarse_bootstrap/launch-icon.png\'][width=\'94\']'), m$1('.fontsize-large.fontweight-semibold.u-marginbottom-20', 'Ready to launch your campaign?'), m$1('.fontsize-base.u-marginbottom-30', 'We have prepared a list with important information for you to review before launching your project!')])]), m$1('.w-col.w-col-3')])])]), m$1('.divider'), m$1('.w-section.section-one-column.bg-gray.section.before-footer', [m$1('.w-container', [m$1('.card.medium.u-marginbottom-60.card-terciary', [m$1('.w-row', [m$1('.w-col.w-col-6.w-clearfix', [m$1('img.card-project-thumb.u-right[src=' + project.large_image + ']')]), m$1('.w-col.w-col-6', [m$1('.u-marginbottom-30.fontsize-base', [m$1('div', [m$1('span.fontweight-semibold', 'Title: '), project.name]), m$1('div', [m$1('span.fontweight-semibold', 'Link: '), 'www.citizensupported.org/' + project.permalink]), m$1('div', [m$1('span.fontweight-semibold', 'Method of financing: '), I18n$1.t(project.mode, I18nScope$27())]), m$1('div', [m$1('span.fontweight-semibold', 'Goal of collection: '), '$ ' + h.formatNumber(project.goal, 2, 3)]), project.online_days !== null ? m$1('div', [m$1('span.fontweight-semibold', 'Deadline: ' + project.online_days + ' ' + (project.online_days > 1 ? 'days' : 'days'))]) : '', m$1('div', [m$1('span.fontweight-semibold', 'Responsible: '), account.owner_name]), m$1('div', [m$1('span.fontweight-semibold', 'SSN/EIN: '), account.owner_document])])])]), m$1('.u-text-center', [m$1('.w-row', [m$1('.w-col.w-col-1'), m$1('.w-col.w-col-10', [m$1('.divider.u-marginbottom-10'), m$1('.fontsize-small.fontcolor-secondary', "The above data can not be changed after the project goes live. If you need to make changes, navigate the sidebar and come back here when you're done!")]), m$1('.w-col.w-col-1')])])]), m$1('.card.medium.u-radius.u-marginbottom-60', [m$1('.u-text-center.u-marginbottom-60', [m$1('.fontsize-large.fontweight-semibold', 'Remember our rules'), m$1('.w-row', [m$1('.w-col.w-col-2'), m$1('.w-col.w-col-8', [m$1('.fontsize-small', ['Before posting, click on the circles below and confirm that you are aware of how Citizen Supported works. Any doubt, ', m$1('a.alt-link[href="http://suporte.citizensupported.org/hc/pt-br/requests/new"][target="_blank"]', 'contact'), '!'])]), m$1('.w-col.w-col-2')])]), _$1.map(project.mode == 'flex' ? flexTerms(project) : terms(project), function (term, index) {
...
var I18nScope$28 = _$1.partial(h.i18nScope, 'pages.start');
...
var start = {
    ...
    view: function view(ctrl, args) {
        ...
        return m$1('#start', { config: h.setPageTitle(I18n$1.t('header_html', I18nScope$28())) }, [m$1('.w-section.hero-full.hero-start', [m$1('.w-container.u-text-center', [m$1('.fontsize-megajumbo.fontweight-semibold.u-marginbottom-40', I18n$1.t('slogan', I18nScope$28())), m$1('.w-row.u-marginbottom-40', [m$1('.w-col.w-col-4.w-col-push-4', [m$1('a.btn.btn-large.u-marginbottom-10[href="#start-form"]', {
            config: h.scrollTo(),
            onclick: h.analytics.event({ cat: 'project_start', act: 'start_btnstart_click' })
        }, I18n$1.t('submit', I18nScope$28()))])]), m$1('.w-row', _$1.isEmpty(stats) ? '' : [m$1('.w-col.w-col-4', [m$1('.fontsize-largest.lineheight-loose', h.formatNumber(stats.total_contributors, 0, 3)), m$1('p.fontsize-small.start-stats', I18n$1.t('header.people', I18nScope$28()))]), m$1('.w-col.w-col-4', [m$1('.fontsize-largest.lineheight-loose', stats.total_contributed.toString().slice(0, 2) + ' millions'), m$1('p.fontsize-small.start-stats', I18n$1.t('header.money', I18nScope$28()))]), m$1('.w-col.w-col-4', [m$1('.fontsize-largest.lineheight-loose', h.formatNumber(stats.total_projects_success, 0, 3)), m$1('p.fontsize-small.start-stats', I18n$1.t('header.success', I18nScope$28()))])])])]), m$1('.w-section.section', [m$1('.w-container', [m$1('.w-row', [m$1('.w-col.w-col-10.w-col-push-1.u-text-center', [m$1('.fontsize-larger.u-marginbottom-10.fontweight-semibold', I18n$1.t('page-title', I18nScope$28())), m$1('.fontsize-small', I18n$1.t('page-subtitle', I18nScope$28()))])]), m$1('.w-clearfix.how-row', [m$1('.w-hidden-small.w-hidden-tiny.how-col-01', [m$1('.info-howworks-backers', [m$1('.fontweight-semibold.fontsize-large', I18n$1.t('banner.1', I18nScope$28())), m$1('.fontsize-base', I18n$1.t('banner.2', I18nScope$28()))]), m$1('.info-howworks-backers', [m$1('.fontweight-semibold.fontsize-large', I18n$1.t('banner.3', I18nScope$28())), m$1('.fontsize-base', I18n$1.t('banner.4', I18nScope$28()))])]), m$1('.how-col-02'), m$1('.how-col-03', [m$1('.fontweight-semibold.fontsize-large', I18n$1.t('banner.5', I18nScope$28())), m$1('.fontsize-base', I18n$1.t('banner.6', I18nScope$28())), m$1('.fontweight-semibold.fontsize-large.u-margintop-30', I18n$1.t('banner.7', I18nScope$28())), m$1('.fontsize-base', I18n$1.t('banner.8', I18nScope$28()))]), m$1('.w-hidden-main.w-hidden-medium.how-col-01', [m$1('.info-howworks-backers', [m$1('.fontweight-semibold.fontsize-large', I18n$1.t('banner.1', I18nScope$28())), m$1('.fontsize-base', I18n$1.t('banner.2', I18nScope$28()))]), m$1('.info-howworks-backers', [m$1('.fontweight-semibold.fontsize-large', I18n$1.t('banner.3', I18nScope$28())), m$1('.fontsize-base', I18n$1.t('banner.4', I18nScope$28()))])])])])]), m$1('.w-section.divider'), m$1('.w-section.section-large', [m$1('.w-container.u-text-center.u-marginbottom-60', [m$1('div', [m$1('span.fontsize-largest.fontweight-semibold', I18n$1.t('features.title', I18nScope$28()))]), m$1('.w-hidden-small.w-hidden-tiny.fontsize-large.u-marginbottom-20', I18n$1.t('features.subtitle', I18nScope$28())), m$1('.w-hidden-main.w-hidden-medium.u-margintop-30', [m$1('.fontsize-large.u-marginbottom-30', I18n$1.t('features.feature_1', I18nScope$28())), m$1('.fontsize-large.u-marginbottom-30', I18n$1.t('features.feature_2', I18nScope$28())), m$1('.fontsize-large.u-marginbottom-30', I18n$1.t('features.feature_3', I18nScope$28())), m$1('.fontsize-large.u-marginbottom-30', I18n$1.t('features.feature_4', I18nScope$28())), m$1('.fontsize-large.u-marginbottom-30', I18n$1.t('features.feature_5', I18nScope$28())), m$1('.fontsize-large.u-marginbottom-30', I18n$1.t('features.feature_6', I18nScope$28()))])]), m$1('.w-container', [m$1('.w-tabs.w-hidden-small.w-hidden-tiny', [m$1('.w-tab-menu.w-col.w-col-4', _$1.map(ctrl.paneImages, function (pane, idx) {
        ...
        }))])])]), m$1('.w-section.section-large.card-terciary', m$1('.w-container', [m$1('.u-text-center.u-marginbottom-40', [m$1('div', m$1('span.fontsize-largest.fontweight-semibold', I18n$1.t('mode.title', I18nScope$28()))), m$1('.w-row', [m$1('.w-col.w-col-1'), m$1('.w-col.w-col-10', m$1('.fontsize-large.u-marginbottom-20', I18n$1.t('mode.subtitle', I18nScope$28()))), m$1('.w-col.w-col-1')])]), m$1('div', m$1('.flex-row.u-marginbottom-40', [m$1('.flex-column.card.u-radius.u-marginbottom-30', [m$1('.u-text-center.u-marginbottom-30', m$1('img[src=\'https://daks2k3a4ib2z.cloudfront.net/54b440b85608e3f4389db387/5632f334ec8a367d341b4bba_badge-aon.png\']')), m$1('.fontsize-large.flex-column.u-marginbottom-20', [I18n$1.t('mode.aon.info', I18nScope$28()), m$1.trust('&nbsp;')]), m$1('.fontsize-base.flex-column.fontcolor-secondary', I18n$1.t('mode.aon.info_2', I18nScope$28()))]), m$1('.flex-column.card.u-radius.u-marginbottom-30', [m$1('.u-text-center.u-marginbottom-30', m$1('img[src=\'https://daks2k3a4ib2z.cloudfront.net/54b440b85608e3f4389db387/5632ebacd092957f34eaea9c_badge-flex.png\']')), m$1('.fontsize-large.flex-column.u-marginbottom-20', I18n$1.t('mode.flex.info', I18nScope$28())), m$1('.fontsize-base.flex-column.fontcolor-secondary', I18n$1.t('mode.flex.info_2', I18nScope$28()))])])), m$1('.u-text-center.u-marginbottom-30', [m$1('.fontsize-large.fontweight-semibold', I18n$1.t('mode.tax_info', I18nScope$28())), m$1('.fontsize-smallest.fontcolor-secondary', [I18n$1.t('mode.failed_info', I18nScope$28()), m$1.trust(I18n$1.t('mode.more_link', I18nScope$28()))])])])), m$1('.w-section.section-large.bg-blue-one', [m$1('.w-container.u-text-center', [m$1('.fontsize-larger.lineheight-tight.fontcolor-negative.u-marginbottom-20', [I18n$1.t('video.title', I18nScope$28()), m$1('en'), I18n$1.t('video.subtitle', I18nScope$28())]), m$1.component(youtubeLightbox, {
            src: I18n$1.t('video.src', I18nScope$28()),
            onclick: h.analytics.event({ cat: 'project_start', act: 'start_video_play' })
        })])]), m$1('.w-hidden-small.w-hidden-tiny.section-categories', [m$1('.w-container', [m$1('.u-text-center', [m$1('.w-row', [m$1('.w-col.w-col-10.w-col-push-1', [m$1('.fontsize-large.u-marginbottom-40.fontcolor-negative', I18n$1.t('categories.title', I18nScope$28()))])])]), m$1('.w-tabs', [m$1('.w-tab-menu.u-text-center', _$1.map(ctrl.categories(), function (category) {
        ...
        }), m$1('.w-section.divider.u-margintop-30'), m$1('.w-container', [m$1('.fontsize-larger.u-text-center.u-marginbottom-60.u-margintop-40', I18n$1.t('qa_title', I18nScope$28())), m$1('.w-row.u-marginbottom-60', [m$1('.w-col.w-col-6', _$1.map(ctrl.questions.col_1, function (question) {
        ...
        }, [m$1('.w-col.w-col-2'), m$1('.w-col.w-col-8', [m$1('.fontsize-larger.fontcolor-negative.u-marginbottom-10', I18n$1.t('form.title', I18nScope$28())), m$1('input[name="utf8"][type="hidden"][value="✓"]'), m$1('input[name="authenticity_token"][type="hidden"][value="' + h.authenticityToken() + '"]'), m$1('input.w-input.text-field.medium.u-marginbottom-30[type="text"]', {
            name: 'project[name]',
        ...
        }, [m$1('option[value="-1"]', I18n$1.t('form.select_default', I18nScope$28())), _$1.map(ctrl.categories(), function (category) {
            return m$1('option[value="' + category.id + '"]', { selected: ctrl.projectCategory() === category.id }, category.name);
        })])]), m$1('.w-col.w-col-2'), m$1('.w-row.u-marginbottom-20', [m$1('.w-col.w-col-4.w-col-push-4.u-margintop-40', [m$1('input[type="submit"][value="' + I18n$1.t('form.submit', I18nScope$28()) + '"].w-button.btn.btn-large')])]), m$1('.w-row.u-marginbottom-80', ctrl.projectNameError() || ctrl.projectCategoryError() ? m$1.component(inlineError, { message: 'Please check the fields above again!' }) : '')])])])]);
    }
};
...
var teamTotal = {
    ...
    view: function view(ctrl, args) {
        return m$1('#team-total-static.w-section.section-one-column.section.u-margintop-40.u-text-center.u-marginbottom-20', [ctrl.vm.collection().map(function (teamTotal) {
            return m$1('.w-container', [m$1('.w-row', [m$1('.w-col.w-col-2'), m$1('.w-col.w-col-8', [m$1('.fontsize-base.u-marginbottom-30', 'Today we are' + teamTotal.member_count + ' people scattered over ' + teamTotal.total_cities + ' cities and towns across the country! Our passion is to assist all of the amazing political activists that are leading the effort to pursue progressive change across the United States. Citizen Supported is independent, open-source and built with love.'), m$1('.fontsize-larger.lineheight-tight.text-success', 'Our team, together, has already raised $' + h.formatNumber(teamTotal.total_amount) + ' for ' + teamTotal.total_contributed_projects + ' campaigns!')]), m$1('.w-col.w-col-2')])]);
        })]);
    }
};
...
var userBalanceRequestModelContent = {
    ...
    view: function view(ctrl, args) {
        ...
        return ctrl.loadBankA() ? h.loader() : m$1('div', _$1.map(ctrl.bankAccounts(), function (item) {
            return [m$1('.modal-dialog-header', [m$1('.fontsize-large.u-text-center', I18n$1.t('withdraw', I18nScope$30()))]), ctrl.displayDone() ? m$1('.modal-dialog-content.u-text-center', [m$1('.fa.fa-check-circle.fa-5x.text-success.u-marginbottom-40'), m$1('p.fontsize-large', I18n$1.t('sucess_message', I18nScope$30()))]) : m$1('.modal-dialog-content', [m$1('.fontsize-base.u-marginbottom-20', [m$1('span.fontweight-semibold', 'Value:'), m$1.trust('&nbsp;'), m$1('span.text-success', '$ ' + h.formatNumber(balance.amount, 2, 3))]), m$1('.fontsize-base.u-marginbottom-10', [m$1('span', { style: { 'font-weight': ' 600' } }, I18n$1.t('bank.account', I18nScope$30()))]), m$1('.fontsize-small.u-marginbottom-10', [m$1('div', [m$1('span.fontcolor-secondary', I18n$1.t('bank.name', I18nScope$30())), m$1.trust('&nbsp;'), item.owner_name]), m$1('div', [m$1('span.fontcolor-secondary', I18n$1.t('bank.cpf_cnpj', I18nScope$30())), m$1.trust('&nbsp;'), item.owner_document]), m$1('div', [m$1('span.fontcolor-secondary', I18n$1.t('bank.bank_name', I18nScope$30())), m$1.trust('&nbsp;'), item.bank_name]), m$1('div', [m$1('span.fontcolor-secondary', I18n$1.t('bank.agency', I18nScope$30())), m$1.trust('&nbsp;'), item.agency + '-' + item.agency_digit]), m$1('div', [m$1('span.fontcolor-secondary', I18n$1.t('bank.account', I18nScope$30())), m$1.trust('&nbsp;'), item.account + '-' + item.account_digit])])]), !ctrl.displayDone() ? m$1('.modal-dialog-nav-bottom', [m$1('.w-row', [m$1('.w-col.w-col-3'), m$1('.w-col.w-col-6', [ctrl.requestLoader() ? h.loader() : m$1('a.btn.btn-large.btn-request-fund[href="js:void(0);"]', { onclick: ctrl.requestFund }, 'Request withdrawal')]), m$1('.w-col.w-col-3')])]) : ''];
        }));
    }
};
...
var userBalance = {
    ...
    view: function view(ctrl, args) {
        ...
        }) : '', m$1('.w-container', [m$1('.w-row', [m$1('.w-col.w-col-8.u-text-center-small-only.u-marginbottom-20', [m$1('.fontsize-larger', [I18n.t('totals', I18nScope$29()), m$1('span.text-success', '$ ' + h.formatNumber(balance.amount, 2, 3))])]), m$1('.w-col.w-col-4', [m$1('a[class="r-fund-btn w-button btn btn-medium u-marginbottom-10 ' + (balance.amount <= 0 ? 'btn-inactive' : '') + '"][href="js:void(0);"]', { onclick: balance.amount > 0 ? ctrl.displayModal.toggle : 'js:void(0);' }, I18n.t('withdraw_cta', I18nScope$29()))])])])]);
    }
};

var I18nScope$31 = _.partial(h.i18nScope, 'users.balance');
...
var userBalanceTrasactionRow = {
    ...
    view: function view(ctrl, args) {
        ...
        return m$1('div[class=\'balance-card ' + (ctrl.expanded() ? 'card-detailed-open' : '') + '\']', m$1('.w-clearfix.card.card-clickable', [m$1('.w-row', [m$1('.w-col.w-col-2.w-col-tiny-2', [m$1('.fontsize-small.lineheight-tightest', createdAt.format('D MMM')), m$1('.fontsize-smallest.fontcolor-terciary', createdAt.format('YYYY'))]), m$1('.w-col.w-col-10.w-col-tiny-10', [m$1('.w-row', [m$1('.w-col.w-col-4', [m$1('div', [m$1('span.fontsize-smaller.fontcolor-secondary', I18n.t('debit', I18nScope$31())), m$1.trust('&nbsp;'), m$1('span.fontsize-base.text-error', '$ ' + h.formatNumber(Math.abs(item.debit), 2, 3))])]), m$1('.w-col.w-col-4', [m$1('div', [m$1('span.fontsize-smaller.fontcolor-secondary', I18n.t('credit', I18nScope$31())), m$1.trust('&nbsp;'), m$1('span.fontsize-base.text-success', '$ ' + h.formatNumber(item.credit, 2, 3))])]), m$1('.w-col.w-col-4', [m$1('div', [m$1('span.fontsize-smaller.fontcolor-secondary', I18n.t('totals', I18nScope$31())), m$1.trust('&nbsp;'), m$1('span.fontsize-base', '$ ' + h.formatNumber(item.total_amount, 2, 3))])])])])]), m$1('a.w-inline-block.arrow-admin.' + (ctrl.expanded() ? 'arrow-admin-opened' : '') + '.fa.fa-chevron-down.fontcolor-secondary[href="js:(void(0));"]', { onclick: ctrl.expanded.toggle })]), ctrl.expanded() ? m$1('.card', _.map(item.source, function (transaction) {
            var pos = transaction.amount >= 0;

            return m$1('div', [m$1('.w-row.fontsize-small.u-marginbottom-10', [m$1('.w-col.w-col-2', [m$1('.text-' + (pos ? 'success' : 'error'), (pos ? '+' : '-') + ' $ ' + h.formatNumber(Math.abs(transaction.amount), 2, 3))]), m$1('.w-col.w-col-10', [m$1('div', transaction.event_name + ' ' + transaction.origin_object.name)])]), m$1('.divider.u-marginbottom-10')]);
        })) : '');
    }
};
...
var thankYou = {
    ...
    view: function view(ctrl, args) {
        return m$1('#thank-you', { config: ctrl.setEvents }, [m$1(".page-header.u-marginbottom-30", m$1(".w-container", m$1(".w-row", m$1(".w-col.w-col-10.w-col-push-1", [m$1(".u-marginbottom-20.u-text-center", m$1('img.big.thumb.u-round[src=\'' + args.contribution.project.user_thumb + '\']')), m$1("#thank-you.u-text-center", !ctrl.isSlip ? [m$1("#creditcard-thank-you.fontsize-larger.text-success.u-marginbottom-20", I18n$1.t('thank_you.thank_you', I18nScope$32())), m$1(".fontsize-base.u-marginbottom-40", m$1.trust(I18n$1.t('thank_you.thank_you_text_html', I18nScope$32({
            total: args.contribution.project.total_contributions,
            email: args.contribution.contribution_email,
            link2: '/users/' + h.getUser().user_id + '/edit#contributions',
            link_email: '/users/' + h.getUser().user_id + '/edit#settings'
        })))), m$1(".fontsize-base.fontweight-semibold.u-marginbottom-20", "Share with your friends and help this project hit the goal!")] : [m$1('#slip-thank-you.fontsize-largest.text-success.u-marginbottom-20', I18n$1.t('thank_you_slip.thank_you', I18nScope$32())), m$1('.fontsize-base.u-marginbottom-40', m$1.trust(I18n$1.t('thank_you_slip.thank_you_text_html', I18nScope$32({
            email: args.contribution.contribution_email,
            link_email: '/users/' + h.getUser().user_id + '/edit#settings'
        ...
        }))) : [m$1('.fontsize-large.fontweight-semibold.u-marginbottom-30.u-text-center', I18n$1.t('thank_you.project_recommendations', I18nScope$32())), m$1.component(projectRow, {
...
var I18nScope$33 = _$1.partial(h.i18nScope, 'users.edit.email_confirmation');
...
var CheckEmail = {
    ...
    view: function view(ctrl, args) {
        var user = ctrl.user();
        return user && !user.email_active && !ctrl.hideAlert() ? m$1('.card-alert.section.u-text-center', { style: args.menuTransparency ? { 'padding-top': '100px' } : {} }, [m$1('.w-container', ctrl.confirmedEmail() ? [m$1('.fontsize-large.fontweight-semibold', I18n$1.t('confirmed_title', I18nScope$33())), m$1('.fontsize-large.fontweight-semibold.u-marginbottom-20', I18n$1.t('confirmed_sub', I18nScope$33()))] : [m$1('.fontsize-large.fontweight-semibold', I18n$1.t('hello', I18nScope$33({ name: user.name }))), m$1('.fontsize-large.fontweight-semibold.u-marginbottom-20', I18n$1.t('hello_sub', I18nScope$33())), m$1('.fontsize-base.u-marginbottom-10', I18n$1.t('hello_email', I18nScope$33({ email: user.email }))), m$1('.w-row', [m$1('.w-col.w-col-3'), m$1('.w-col.w-col-3', [m$1('a.btn.btn-medium.btn-terciary.w-button[href="javacript:void(0);"]', {
...
//# sourceMappingURL=data:application/json;charset=utf8;base64,
