                ...
                return m('.w-row.card', [
                    ...
                    m('.w-col.w-col-3.u-marginbottom-10', [
                        ...
                        (contributionVM.canShowReceipt(contribution) ?
                            m(`a.btn.btn-inline.btn-small.u-margintop-10.btn-terciary[href='https://www.citizensupported.org/projects/${contribution.project_id}/contributions/${contribution.contribution_id}/receipt'][target='__blank']`,
                                'View Receipt'
                            ) : ''),
                        ...
                        (contributionVM.canGenerateSlip(contribution) ?
                            m(`a.btn.btn-inline.btn-small.u-margintop-10[href='https://www.citizensupported.org/projects/${contribution.project_id}/contributions/${contribution.contribution_id}/second_slip'][target='__blank']`,
                                'Generate 2nd via'
                            ) : ''),
